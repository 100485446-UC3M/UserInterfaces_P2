...
$(document).ready(function() {
    ...
    $("#register-form").submit(function(e) {
        ...
        const apellidosPartes = $("#Apellido").val().trim().split(/\s+/); //Se utiliza regex para considerar múltiples espacios
        ...
        if (!/(?=.*[0-9].*[0-9])(?=.*[!@#$%^&*])(?=.*[a-z])(?=.*[A-Z]).{8,}/.test(password)){ //Se realiza con lookaheads y definiendo el mínimo de caracteres
